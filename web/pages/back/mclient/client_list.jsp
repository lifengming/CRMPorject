...
<script type="text/javascript" src="<%=basePath%>js/pages/back/mclient/client_list.js"></script>
</head>
<body>
						...
						<c:forEach items="${allClients}" var="client">
							<tr>
                                ...
                                <c:if test="${allActions['29']!=null}">
                                    <td><a href="<%=basePath%>${allActions['29'].url}?cid=${client.cid}&name=${client.name}" class="tablelink">任务列表</a></td>
                                </c:if>
							</tr>
						</c:forEach>
					</c:if>

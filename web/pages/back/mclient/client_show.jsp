...
<%
	...
	String addUrl = basePath
			+ "pages/back/mclient/ManagerClientServletBack/show";
%>
<html>
<head>
<base href="<%=basePath%>">
...
<body>
	...
	<div class="formbody">
			...
			<ul class="forminfo">
                ...
                <li><label>客服人员</label><i>${client.member.mid}</i></li>
				...
				<li><label>备注</label>
                    <textarea name="client.note" id="client.note" cols="" rows="" class="textinput">${client.note}
                    </textarea>
                </li>
                <%--<li>--%>
                    <%--<label>--%>

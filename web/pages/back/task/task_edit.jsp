...
<script type="text/javascript" src="/js/pages/back/task/task_edit.js"></script>
		...
		<form action="<%=editUrl%>" method="post" id="myform">
			<ul class="forminfo">
				...
				<li><label>预计安排时间</label>
					<input id="task.tdate" name="task.tdate" type="text" class="Wdate" placeholder="选择任务的完成日期" onClick="WdatePicker({readOnly:true,minDate:'%y-%M-%d'})" value="${task.tdate}"/>

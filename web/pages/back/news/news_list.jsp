...
<script type="text/javascript" src="<%=basePath%>js/pages/back/news/news_list.js"></script>
</head>
<body>
	<div class="place">
		<span>位置：</span>
	...
	<div class="rightinfo">
		...
		<jsp:include page="/pages/plugins/split_page_search_plugin_mvc.jsp"/>
					...
					<c:forEach items="${allNews}" var="news">
						<tr>
                            ...
                            <c:if test="${allActions['33'] != null}">
                                <td>
                                    <a href="<%=basePath%>${allActions['33'].url}?news.nid=${news.nid}" target="rightFrame">
